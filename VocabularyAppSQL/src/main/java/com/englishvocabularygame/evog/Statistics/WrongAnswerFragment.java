...
public class WrongAnswerFragment extends Fragment {
    ...
    ListView listView;
    View rootView;
    StatisticsCursorAdapter customAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.summary_listviews, container, false);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        customAdapter = new StatisticsCursorAdapter(getContext(), getCursor(), 0);
...
//        int previoudTestId = stats.getInt(testIdPreference, 1) - 1;
        ...
        String selectionArgs[] = {testId, "false"};
